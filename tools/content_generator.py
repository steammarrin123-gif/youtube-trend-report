...
━━━━━━━━━━━━━━━
🌤️ 오늘 날씨 & 옷차림
• [오늘 날씨에 맞는 {ages['baro_months']}개월 아이 옷차림 — 구체적으로 (속옷, 겉옷, 주의사항 등)]
• [외출 시 날씨 관련 주의사항 1줄]
...
주의사항: 의학적으로 정확한 정보만. 이모지 유지. 본문만 출력."""
    ...
    wedding_day = date(2023, 10, 29)
    d_plus = (today - wedding_day).days

    prompt_spouse = f"""오늘은 {date_str}이야.

오늘 아내 정보:
- 이름: 이예원 (결혼 D+{d_plus}일)
- 생년월일: 1993년 01월 31일
- 직업: 첼로 선생님
